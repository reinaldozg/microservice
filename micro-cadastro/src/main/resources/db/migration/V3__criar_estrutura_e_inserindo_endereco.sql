...
CREATE SEQUENCE endereco_tipo_id_seq;
...
CREATE TABLE pais (
    ...
    sigla character varying(5) COLLATE pg_catalog."default",
...
CREATE TABLE estado (
    ...
    CONSTRAINT fkb4bn57lisujcm38cprwo27k2g FOREIGN KEY (pais)
...
CREATE TABLE cidade (
    ...
    CONSTRAINT fkedwmmd3jtkssgrwyugrindb7j FOREIGN KEY (estado)
...
--CRIAR TABELA DE TIPOS DE ENDEREÇOS
CREATE TABLE endereco_tipo
(
    id bigint NOT NULL DEFAULT nextval('endereco_tipo_id_seq'::regclass),
    ...
    CONSTRAINT endereco_tipo_pkey PRIMARY KEY (id)
);
...
CREATE TABLE endereco(
    ...
    referencia character varying(200) COLLATE pg_catalog."default",
    cidade integer NOT NULL,
    endereco_tipo bigint NOT NULL,
    CONSTRAINT endereco_pkey PRIMARY KEY (id),
    CONSTRAINT fkhu4avfrkfp65jedddkxe70r9a FOREIGN KEY (cidade)
        REFERENCES cidade (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID,
    CONSTRAINT fkoy07sgy06eoa6q8e21h2a0kei FOREIGN KEY (endereco_tipo)
        REFERENCES endereco_tipo (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID,
    CONSTRAINT fk938724uhua6q8e21h2a0kei FOREIGN KEY (pessoa)
...
-- INSERINDO ENDEREÇOS
INSERT INTO endereco_tipo(descricao, ativo, data_inclusao, ultima_atualizacao, excluido) VALUES ('Comercial', TRUE, now(), NULL, FALSE);
INSERT INTO endereco_tipo(descricao, ativo, data_inclusao, ultima_atualizacao, excluido) VALUES ('Entrega', TRUE, now(), NULL, FALSE);
INSERT INTO endereco_tipo(descricao, ativo, data_inclusao, ultima_atualizacao, excluido) VALUES ('Correspondência', TRUE, now(), NULL, FALSE);
